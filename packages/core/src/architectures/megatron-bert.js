...
export default {
  ...
  models: [
    ...
    {
      model_id:
        "onnx-internal-testing/tiny-random-MegatronBertForTokenClassification-ONNX",
      dtype: "fp32",
      ops: [
        "Add",
        "Cast",
    ...
    {
      model_id:
        "onnx-internal-testing/tiny-random-MegatronBertForMaskedLM-ONNX",
      dtype: "fp32",
      ops: [
        "Add",
        "Cast",
    ...
    {
      model_id: "onnx-internal-testing/tiny-random-MegatronBertModel-ONNX",
      dtype: "fp32",
      ops: [
        "Add",
        "Cast",
